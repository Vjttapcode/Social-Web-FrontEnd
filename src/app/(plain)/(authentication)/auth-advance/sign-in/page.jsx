...
const SignIn = () => {
  return (
    <>
      ...
      <AuthAdvanceLayout>
        <Col xs={12}>
          <h1 className="display-4 text-white mb-4 position-relative">Welcome back to ULearn!</h1>
        ...
        <Col sm={10} md={8} lg={6} className="position-relative z-index-1">
          <Card className="card-body p-4 p-sm-5 mt-sm-n5 mb-n5">
            ...
            <p>
              Don&apos;t have an account?<Link to="/auth-advance/sign-up"> Click here to sign up</Link>
            </p>
            <LoginForm />
          </Card>
        </Col>
