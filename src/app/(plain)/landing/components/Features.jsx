...
const FeatureCard = ({
  ...
  return <Card className="card-body bg-mode shadow-none border-0 p-4 p-lg-5">
      <div>
...
const Features = () => {
  return <section className="py-4 py-sm-5">
      <Container>
        <Row className="g-4 g-lg-5 align-items-center">
            ...
            <Card className="card-body bg-mode shadow-none border-0 p-4 p-sm-5 pb-sm-0 overflow-hidden">
              <Row className="g-4">
                ...
                <Col md={6} className="text-end">
                  <div className="iphone-x iphone-x-small iphone-x-half mb-n5 mt-0" style={{
          ...
          {featureData.map((feature, idx) => <Col md={4} key={idx}>
              <FeatureCard {...feature} />
            </Col>)}
        </Row>
      </Container>
