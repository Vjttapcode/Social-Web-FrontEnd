...
const MainBanner = () => {
  return <section className="pt-5 pb-0 position-relative">
      <Container>
        ...
        <Row className="g-0 align-items-center mt-2 position-relative z-index-1">
          <Col lg={4}>
            <div className="iphone-x iphone-x-small" style={{
            background: `url(${appPlaceholder})`,
            backgroundSize: '100%'
          }}>
              <i />
              <b />
              ...
              <div className="mac_scaler">
                <div className="mac_holder">
                  <div className="mac_screen">
                    ...
                    <div className="mac_screen_content" style={{
