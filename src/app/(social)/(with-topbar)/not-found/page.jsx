...
const NotFound = () => {
  return <>
     <PageMetaData title='Error 404' />
      <main className="py-5">
        <Container>
          <div className="h-100px d-none d-lg-block" />
          <Row className="align-items-center text-center py-sm-5">
            <Col lg={8} className="mx-auto">
              <figure className="m-0 pt-5 pt-md-0">
                <svg className="col-sm-7 col-lg-5" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1285.3 712.4" xmlSpace="preserve">
          ...
          C1041.5,672.8,1103.1,678.7,1103.1,685.3z" />
                        <g>
                          ...
                          <path style={{
                          fill: 'url(#SVGID_00000017490826837838658910000002142626527740690084_)'
                        }} d="M484,594.6
            ...
            c9.5-15.1,21.5-28.8,33.8-35.4c2.6-1.4,5.3-2.5,7.9-3.2l10.5,36.2L309.1,702.8z" />
                          <linearGradient id="SVGID_00000034068006629406653660000012692420182534256547_" gradientUnits="userSpaceOnUse" x1="437.5333" y1="-327.5063" x2="414.9105" y2="-426.9531" gradientTransform="matrix(1 0 0 -1 0 310)">
                            ...
                            <stop offset="0.9649" style={{
                            stopColor: '#173DB8'
                          }} />
                          </linearGradient>
                          <path style={{
                          fill: 'url(#SVGID_00000034068006629406653660000012692420182534256547_)'
            ...
            C571.5,677,576.3,692.2,579.3,707.5z" />
                          ...
                          <path style={{
                          fill: 'url(#SVGID_00000101803975007610050020000011470946412395280313_)'
                        }} d="M957.4,701.2
            ...
            c21.4,16.7,39.7,45.4,53.1,73C948.9,680.1,953.6,691.2,957.4,701.2z" />
                          ...
                          <path style={{
                          fill: 'url(#SVGID_00000030466211624571626890000017464207134027537062_)'
