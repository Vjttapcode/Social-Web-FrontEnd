...
const MenuItemWithChildren = ({
  ...
  return <Dropdown as="li" className={itemClassName} drop={level >= 2 ? 'end' : undefined}>
      <DropdownToggle as={Link} to="" role="button" className={clsx('content-none', linkClassName)} data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
        {item.label}
